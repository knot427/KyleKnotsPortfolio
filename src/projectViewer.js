...
export class ProjectViewer extends React.Component {
    constructor(props) {
        ...
        this.state = {
            projectArray: [
                ['AWS Sensor Database', 'October 2022', "The creation and management of a system that takes data from a number of LoRaWAN connected sensors and routes it through AWS IoT into a DynamoDB database.", null, null],
                ['Digital Portfolio', 'July 2022', "A collection of information and links that help people interested in my work to get to know me better. It was built using react and JavaScript. You are reading it right now!", null, "https://github.com/knot427/KyleKnotsPortfolio"],
                ['Giselle Generator', 'June 2022', "A convolutional generative adversarial network that generates 32X32 colour images of my girlfriend’s face. It was built using python and trained on a dataset of handpicked photos from my phone.", null, "https://github.com/knot427/Giselle-Generator"],
                ['Course Querier', 'April 2022', "A full stack application that involved a front end written in pure HTML allowing a user to communicate with a server using a REST API to perform complex data querying on various datasets. The backend server was written using typescript and was able to handle large amounts of data, complex multi-stage queries, and backing up to disc. Unfortunately, due to it being a school project I do not have the right to share a link to the code for the project.", null, null],
